...
class BitModelTest(unittest.TestCase):
    ...
    def test_model_forward(self, dtype, mode):
        ...
        pt_module = "transformers.BitBackbone"
        ms_module = "mindone.transformers.BitBackbone"
        ...
        self.assertTrue(
            ...
            f"For BitBackbone forward test, mode: {mode}, ms_dtype: {ms_dtype}, pt_type:{pt_dtype},"
